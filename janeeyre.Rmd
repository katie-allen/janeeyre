...
```{r}
jane_dct <- as.numeric(get_dct_transform(posneg$overall,  low_pass_size = 6, x_reverse_len = 100, scale_vals = T, scale_range = F))
...
levels(emotions$sentiment) <- c("Anger", "Anticipation", "Disgust", "Fear", "Joy", "Sadness", "Surprise", "Trust")
